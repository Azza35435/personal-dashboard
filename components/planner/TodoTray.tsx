...
export default function TodoTray({ todos, scheduledTodoIds, pickedTodoId, onPick, onDropOnTimeline }: Props) {
  ...
  return (
    <div className="w-64 flex-shrink-0 flex flex-col rounded bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 border-l-2 border-l-rose-400 shadow-sm overflow-hidden">
